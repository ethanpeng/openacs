...
public abstract class ServicePropertyBean implements EntityBean {
    ...
    // </editor-fold>
    public ServicePropertyPK ejbCreate(Integer parentId, String name, String value) throws CreateException {
        if (parentId == null) {
    ...
    public abstract void setService(ServiceLocal host);

    public abstract Integer getServiceid();

    public abstract void setServiceid(Integer serviceid);

    public abstract Boolean getIsparam();

    public abstract void setIsparam(Boolean isparam);
}
